...
async function ejecutar() {
    ...
    const productos = new Contenedor('./ch2.txt');
    ...
    console.log('Producto agregado con Id: ' + await productos.save(producto));
    producto = new Producto('Salsa de tomate', 19.99, 'https://http2.mlstatic.com/D_NQ_NP_802492-MLA46925625579_072021-O.webp');    
    console.log('Producto agregado con Id: ' + await productos.save(producto));
    console.log('');
